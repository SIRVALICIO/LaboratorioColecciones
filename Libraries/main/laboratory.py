        ...
        if b=="ESTANDAR":
            ...
            print("la desviacion estandar de la Santander es: ",statistics.stdev(santander.values()),"°C")
              ...
              if b=="HEATBLAST":
                  ...
                  Maxprom= MaxGuajira+MaxNarino+MaxSantander
                  print("El promedio de los meses mas calientes es de: ",Maxprom,"°C")
              else:
                if b=="MAX":
